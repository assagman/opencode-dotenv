...
This document describes the release process for opencode-dotenv. Follow these steps in order.
...
**Full Changelog**: https://github.com/assagman/opencode-dotenv/compare/vPREVIOUS...vX.Y.Z
EOF
)"
```
...
1. **npm**: https://www.npmjs.com/package/opencode-dotenv
2. **GitHub Releases**: https://github.com/assagman/opencode-dotenv/releases
